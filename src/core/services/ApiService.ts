...
class ApiService {
   ...
   * @returns Promise<AxiosResponse>
   */
  public static getData(resource: any,): Promise<AxiosResponse> {
   ...
   * @returns Promise<AxiosResponse>
   */
  public static getDataValue(resource: any): Promise<AxiosResponse> {
    return ApiService.vueInstance.axios.get(`${resource}`);
  }

  public static deleteData(resource: string): Promise<AxiosResponse> {
